...
def cambiar_estado(ordenes):
    ...
    if len(ordenes) == 0:
        ...
        if eleccion >= 1 and eleccion <= len(ordenes):
            nuevo_estado = int(input("Ingrese el nuevo estado (1.iniciado, 2.en preparacion, 3.finalizado): "))
            if nuevo_estado == 1 : 
                ordenes[eleccion - 1] ["estado"] = "iniciado"
            elif nuevo_estado == 2 :
                ordenes[eleccion - 1] ["estado"] = "en preparacion"
            elif nuevo_estado == 3 :
                ordenes[eleccion - 1] ["estado"] = "finalizado"  
